...
case $COMMAND in
    lsa-wordcontext)
        echo "latent semantic analysis with word-context matrix..."
        python models/word_utils.py latent_semantic_analysis data/tmp.txt data/lsa-wordcontext.vecs wordcontext
        ;;
    lsa-pmi)
        echo "latent semantic analysis with pmi matrix..."
        python models/word_utils.py latent_semantic_analysis data/tmp.txt data/lsa-pmi.vecs pmi
        ;;
    word2vec)
    ...
    swivel)
        ...
        python ../models/research/swivel/swivel.py --input_base_path data/swivel.data --output_base_path data/swivel.vecs
        ;;
esac